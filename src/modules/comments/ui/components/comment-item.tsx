...
import { ChevronDownIcon, ChevronUpIcon, Flag, MessageSquareIcon, MoreVerticalIcon, ThumbsDownIcon, ThumbsUpIcon, Trash2Icon } from "lucide-react";
    ...
    <div>
      <div className="flex gap-4">
        ...
        <div className="flex-1 min-w-0">
          ...
          <div className="flex items-center gap-2 mt-1">
            ...
            {variant === "comment" && (
              <Button className="h-8" variant="ghost" size="sm" onClick={() => setIsReplyOpen(curr => !curr)}>Reply</Button>
            )}
          </div>
        </div>
      ...
      {isReplyOpen && variant === "comment" && (
        <div className="mt-4 pl-14">
          <CommentForm variant="reply" parentId={comment.id} videoId={comment.videoId} onCancel={() => setIsReplyOpen(false)} onSuccess={() => {
